    ...
    <Box sx={{ padding: 4, backgroundColor: '#fff', minHeight: '100vh', color: '#333' }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">12,361</Typography>
            <Typography variant="body2" color="textSecondary">Emails Sent</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">43,225</Typography>
            <Typography variant="body2" color="textSecondary">Sales Obtained</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">32,441</Typography>
            <Typography variant="body2" color="textSecondary">New Clients</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">1,335,134</Typography>
            <Typography variant="body2" color="textSecondary">Traffic Received</Typography>
          </Paper>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={2} sx={{ mt: 4 }}>
        ...
        <Grid item xs={12} md={8}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">Revenue Generated</Typography>
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">Recent Transactions</Typography>
            <Box sx={{ mt: 2 }}>
      ...
      <Grid container spacing={2} sx={{ mt: 4 }}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">Campaign</Typography>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ padding: 2, backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
            <Typography variant="h6" color="primary">Sales Quantity</Typography>
            <TableContainer>
              <Table>
                <TableHead>
                  <TableRow>
...
const TransactionItem = ({ id, date, amount }) => (
  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
    ...
    <Typography variant="body2" fontWeight="bold" color="#333">{amount}</Typography>
  </Box>
);
