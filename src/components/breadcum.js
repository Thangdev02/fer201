...
const CountryBreadcrumbs = () => {
  ...
  return (
    <div role="presentation" style={{ padding: "10px 20px", backgroundColor: "#f5f5f5", borderRadius: "8px" }}>
      <Breadcrumbs
        separator={<NavigateNextIcon fontSize="small" sx={{ color: "green" }} />} // Màu cho icon phân cách
